        ...
        public MainWindowViewModel() {
            var apps = new List<InstallFreakApps> {
                new InstallFreakApps(
                    false, "EmuGUI", "2.0.3.5614", "https://github.com/Tech-FZ/EmuGUI/releases/download/v2.0.3.5614/EmuGUI_v2.0.3.5614_Win_amd64.zip",
                    "https://github.com/Tech-FZ/EmuGUI/releases/download/v2.0.3.5614/EmuGUI_v2.0.3.5614_Win_amd64.zip.sha256", "",
